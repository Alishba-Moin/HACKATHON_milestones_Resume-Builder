...
function generateResumeContent() {
    ...
    if (resumeContent) {
        resumeContent.innerHTML = `
            ...
            ${skillsListHtml}
        `;
        const uniqueFileName = name ? `resume_${name.replace(/\s+/g, "_")}.html` : "resume_unknown.html";
        ...
        resumeContent.appendChild(downloadLink);
        // Print as PDF
        const printButton = document.createElement('button');
        printButton.textContent = "Download as PDF";
        printButton.classList.add('print-button'); // Add class for styling
        printButton.addEventListener("click", () => window.print());
        resumeContent.appendChild(printButton);
        // Copy Shareable Link
        ...
        shareButton.addEventListener("click", async () => {
            const shareLink = name
                ? `https://yourdomain.com/resumes/${name.replace(/\s+/g, "_")}.html`
                : "https://yourdomain.com/resumes/unknown.html";
            try {
        ...
        resumeContent.appendChild(shareButton);
    }
    if (resumeDiv) {
